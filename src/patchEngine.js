...
function patchExtensionMetadataHelper(text, context) {
  if (text.includes('codexLocalGroupsPatchVersion=14')) {
    return upgradeExtensionHostHelperRuntime(fixInjectedWhitespaceRegex(text));
  }
  if (text.includes('codexLocalGroupsPatchVersion=13')) {
    ...
    return upgradeExtensionHostHelperRuntime(next);
  }
...
function upgradeExtensionHostHelperRuntime(text) {
  if (text.includes('codexLocalGroupsGroupArchived')) {
    return text;
  }
...
function metadataMergeSnippet() {
  return 'function codexLocalGroupsMergeMeta(e,t){let n={version:1,updatedAtMs:Math.max(e.updatedAtMs??0,t.updatedAtMs??0),conversations:{...(e.conversations??{})},archivedGroups:{...(e.archivedGroups??{})},pendingGroup:e.pendingGroup,migrations:e.migrations},r=(t.updatedAtMs??0)>(e.updatedAtMs??0);r&&(n.pendingGroup=t.pendingGroup);for(let[i,a]of Object.entries(t.archivedGroups??{})){let o=n.archivedGroups[i];n.archivedGroups[i]=!o||(a.archivedAtMs??0)>(o.archivedAtMs??0)?a:o}for(let[i,a]of Object.entries(t.conversations??{})){let o=n.conversations[i];n.conversations[i]=!o||(a.updatedAtMs??0)>(o.updatedAtMs??0)?{...(o??{}),...a,title:a.title??o?.title}:o}return n}';
}
