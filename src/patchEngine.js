...
function patchExtensionMetadataHelper(text, context) {
  if (text.includes('codexLocalGroupsPatchVersion=11')) {
    return text;
  }
...
function patchHeader(text, context, file) {
  ...
  if (next.includes('codexLocalGroupsHeaderPatchVersion=21')) {
    return next;
  }
...
function patchHeaderRefreshHook(text, context) {
  ...
  next = next.replace(/codexLocalGroupsHeaderPatchVersion=1[789]|codexLocalGroupsHeaderPatchVersion=21/g, 'codexLocalGroupsHeaderPatchVersion=21');
  return next;
}
