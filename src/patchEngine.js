...
function patchHeader(text, context, file) {
  ...
  if (next.includes('codexLocalGroupsHeaderPatchVersion=26') && next.includes('titleOverride:o?(0,Q.jsx)(Q.Fragment,{children:o}):void 0')) {
    return next;
  }
...
function patchHeaderRefreshHook(text, context) {
  ...
  next = next.replace(/codexLocalGroupsHeaderPatchVersion=1[789]|codexLocalGroupsHeaderPatchVersion=2[123456]/g, 'codexLocalGroupsHeaderPatchVersion=26');
  return next;
}
